...
class Message(Base):
    ...
    # Trust signals for grounded answers (assistant messages only).
    # confidence: "grounded" | "partial" | "unsupported" | None.
    confidence: Mapped[str | None] = mapped_column(String, nullable=True)
    # citations: list of {marker, document_id, filename, page, heading, snippet}.
